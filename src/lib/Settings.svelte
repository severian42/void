...
const defaultModel:Model = 'ANIMA'
...
const systemPromptSettings: ChatSetting[] = [
      ...
      },
      {
        ...
        placeholder: 'Enter the first prompt to send here. You can tell ANIMA how to act.',
        type: 'textarea',
        hide: (chatId) => !getChatSettings(chatId).useSystemPrompt
      },
      {
        key: 'sendSystemPromptLast',
        name: 'Send System Prompt Last (Can be helpful as a reminder to ANIMA)',
        title: 'Sending the system prompt at the end instead of the start of the messages can help.',
        type: 'boolean'
      },
      {
        ...
        placeholder: 'Enter user prompt prefix here.  You can remind ANIMA how to act.  Use ::EOM:: to separate messages.',
        type: 'textarea',
        hide: (chatId) => !getChatSettings(chatId).useSystemPrompt
      },
      {
...
const summarySettings: ChatSetting[] = [
      ...
      },
      {
        ...
        options: [
          ...
          { value: 1, text: '1 - Allow one extra request to extend.' },
          { value: 2, text: '2 - Allow two extra request to extend.' }
        ],
        hide: (chatId) => getChatSettings(chatId).continuousChat !== 'summary'
      },
      {
